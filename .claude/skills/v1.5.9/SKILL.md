---
name: Version 1.5.9 Complete
description: >
  v1.5.9 captures v1.5.9. Reference this skill when inspecting or extending this historical SafeCode Agent version.
---

# Version 1.5.9 - v1.5.9 snapshot

## Status
Implemented and tagged as `v1.5.9` at `acdc569`.
...
`v1.5.9` implements the `v1.5.9` milestone from `v1.5.x: Core Security Boundary`.

- Historical branch: `v1.5.9-apply-metadata-preimage`
- Main entry: `src/safecode/patch/applier.py`

## Main Files
- `src/safecode/patch/applier.py`

## Acceptance Commands
- mode preserved、non-UTF-8 rejected、preimage rechecked
