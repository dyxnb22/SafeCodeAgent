---
name: Version 1.7.2 Complete
description: >
  v1.7.2 captures v1.7.2. Reference this skill when inspecting or extending this historical SafeCode Agent version.
---

# Version 1.7.2 - v1.7.2 snapshot

## Status
Implemented and tagged as `v1.7.2` at `8a1516d`.
...
`v1.7.2` implements the `v1.7.2` milestone from `v1.7.x: OS-Level Sandbox Containment`.

- Historical branch: `v1.7.2-linux-bubblewrap-args-plan`
- Main entry: `src/safecode/sandbox/bubblewrap.py`、`src/safecode/sandbox/adapter.py::LinuxBubblewrapAdapter`

## Main Files
- `src/safecode/sandbox/bubblewrap.py`
- `src/safecode/sandbox/adapter.py::LinuxBubblewrapAdapter`
