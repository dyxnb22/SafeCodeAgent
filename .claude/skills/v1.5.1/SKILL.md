---
name: Version 1.5.1 Complete
description: >
  v1.5.1 captures v1.5.1. Reference this skill when inspecting or extending this historical SafeCode Agent version.
---

# Version 1.5.1 - v1.5.1 snapshot

## Status
Implemented and tagged as `v1.5.1` at `40eccb6`.
...
`v1.5.1` implements the `v1.5.1` milestone from `v1.5.x: Core Security Boundary`.

- Historical branch: `v1.5.1-transactional-apply`
- Main entry: `src/safecode/patch/applier.py`、`src/safecode/checkpoint/manager.py`
