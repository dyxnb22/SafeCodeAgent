---
name: Version 1.7.1 Complete
description: >
  v1.7.1 captures v1.7.1. Reference this skill when inspecting or extending this historical SafeCode Agent version.
---

# Version 1.7.1 - v1.7.1 snapshot

## Status
Implemented and tagged as `v1.7.1` at `7b08cde`.
...
`v1.7.1` implements the `v1.7.1` milestone from `v1.7.x: OS-Level Sandbox Containment`.

- Historical branch: `v1.7.1-macos-seatbelt-profile-plan`
- Main entry: `src/safecode/sandbox/seatbelt.py`、`src/safecode/sandbox/adapter.py::MacOSSeatbeltAdapter`

## Main Files
- `src/safecode/sandbox/seatbelt.py`
- `src/safecode/sandbox/adapter.py::MacOSSeatbeltAdapter`
