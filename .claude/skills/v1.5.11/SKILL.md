---
name: Version 1.5.11 Complete
description: >
  v1.5.11 captures v1.5.11. Reference this skill when inspecting or extending this historical SafeCode Agent version.
---

# Version 1.5.11 - v1.5.11 snapshot

## Status
Implemented and tagged as `v1.5.11` at `1fbc8b0`.
...
`v1.5.11` implements the `v1.5.11` milestone from `v1.5.x: Core Security Boundary`.

- Historical branch: `v1.5.11-hook-approval-trust`
- Main entry: `src/safecode/hooks/approvals.py`、`src/safecode/hooks/runner.py`
...
## Acceptance Commands
- 用户级 approval + config/user/expiry binding + allow switch
