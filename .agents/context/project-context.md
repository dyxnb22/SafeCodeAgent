...
- Portfolio track: `v3.3` ready; next task `v3.3.1-T1` (interview case study).
  Portfolio delivery through `v3.2` added planning hygiene, `sac demo pr-review
  --offline`, and transcript snapshots without closing enterprise GA gates
  G1/G2/G3.
...
| v3.3 | Interview case study | Ready (`v3.3.1-T1`) | `product-planning/post-ga-portfolio-roadmap.md` |
