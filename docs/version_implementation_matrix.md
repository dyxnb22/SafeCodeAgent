...
| `v5.4.2` ✅ | `dev/v4.19` | `README.md`, `docs/providers.md`, `docs/mvp-user-guide.md`, `docs/troubleshooting.md` | MCP depth docs cut: README "MCP Integration (v5.4, EXPERIMENTAL)" section with server config, native tool bridge, write approval flow, and `mcp_<server>_<tool>` naming policy. MVP guide "Extending with MCP Servers" section with sqlite walkthrough. Troubleshooting "MCP Integration Issues" covering tool-not-in-/tools, write-tool-blocked, and name-collision cases. docs/providers.md MCP server configuration reference updated with scope values, native bridge requirements, write proposal flow. |
...
| `v5.5.2` ✅ | `dev/v4.19` | `docs/install-update.md`, `docs/project-final-status-and-roadmap.md`, `README.md`, `docs/version_implementation_matrix.md` | Production docs cut: install-update.md adds full install matrix (PyPI/Homebrew/offline/source dev table + per-method install blocks); project-final-status-and-roadmap.md updated to v5.5.2 baseline with distribution and MCP capability tables; README install section rewritten (PyPI first, Homebrew second); README status badge "Production (v5.5)". |
...
| `v6.2.2` ✅ | `dev/v4.19` | `README.md`, `docs/public-contracts.md`, `docs/version_implementation_matrix.md`, `docs/mvp-user-guide.md`, `.claude/skills/current/SKILL.md`, `.claude/versions.json` | Docs cut: README "Project Memory" section; public-contracts Section 21 candidate; matrix v6.2.x rows; MVP guide memory workflow. |
...
| `v6.6.3` ✅ | `dev/v4.19` | `README.md`, `docs/mvp-user-guide.md`, `docs/public-contracts.md`, `docs/security/threat-model-v3.6.md`, `docs/version_implementation_matrix.md`, `tests/test_mvp_docs.py`, `src/safecode/agent/loop.py`, `src/safecode/cli_shell.py` | Docs cleanup: Trust Modes marked Stable Contract #18, GitHub write workflow marked Stable Contract #20, Project Memory candidate fixed to Section 21, stale README version wording removed, provider/memory/search duplication points to canonical docs, doc guards updated, and noisy runtime version comments reduced. |
...
| `v7.0.1` ✅ | `dev/v4.19` | `pyproject.toml`, `src/safecode/__init__.py`, `README.md`, `.claude/versions.json`, `.claude/skills/current/SKILL.md`, `docs/reference/version-summary.md`, `docs/version-plans/v7.0.x-agent-productization-followup.md`, `tests/test_docs_governance.py` | Metadata and narrative sync: package/runtime metadata, README/status claims, current planning docs, and docs governance align with v7.0.x, 36 default live fixtures, and 23 stable contracts. |
