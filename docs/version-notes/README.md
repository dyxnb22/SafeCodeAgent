...
| --- | ---: | --- | --- |
| v4 | 58 | shell-first, provider profiles, first-run usability (v4.14–v4.16), interaction quality (v4.17–v4.18), resume MVP, agentic loop, debug/memory/local git | [v4.18.1](v4.18.1-agent-loop-transparency.md), [v4.18.0](v4.18.0-diff-rendering-per-patch-undo.md), [v4.17.3](v4.17.3-fuzzy-matching.md), [v4.17.2](v4.17.2-live-connectivity.md), [v4.17.0](v4.17.0-streaming-output.md), [v4.16.2](v4.16.2-error-message-rewrite.md), [v4.15.0](v4.15.0-sac-init-front-door.md), [v4.14.0](v4.14.0-provider-profile-ux.md) |
