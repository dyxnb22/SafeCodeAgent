...
| --- | ---: | --- | --- |
| v7 | 9 | second stable contract cut, v7.0.x productization, and v7.1 eval maturity | [v7.1.3](v7.1.3-balanced-negative-evals.md), [v7.1.2](v7.1.2-multi-grader-schema.md), [v7.1.1](v7.1.1-live-eval-transcripts.md), [v7.1.0](v7.1.0-eval-suite-split.md), [v7.0.4](v7.0.4-session-shell-polish.md), [v7.0.3](v7.0.3-productized-subagent-roles.md), [v7.0.2](v7.0.2-single-command-agent-run.md), [v7.0.1](v7.0.1-metadata-narrative-sync.md), [v7.0.0](v7.0.0-second-stable-contract-cut.md) |
