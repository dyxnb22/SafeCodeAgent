...
| --- | ---: | --- | --- |
| v7 | 3 | second stable contract cut plus v7.0.x productization follow-up | [v7.0.2](v7.0.2-single-command-agent-run.md), [v7.0.1](v7.0.1-metadata-narrative-sync.md), [v7.0.0](v7.0.0-second-stable-contract-cut.md) |
