...
This directory keeps historical audits, roadmaps, and planning documents that
...
- [Commercial v1 Readiness Audit v3.6.6](audits/commercial-v1-readiness-audit-v3.6.6.md): earlier commercial readiness audit.
- [Product Audit v2.6.21](audits/product-audit-v2.6.21.md): historical product-level audit.

## Roadmaps and Review Follow-ups

- [Productization Roadmap to Claude Code](roadmaps/productization-roadmap-to-claude-code.md): historical productization context.
- [v0.1 Implementation Plan](roadmaps/v0_1_implementation_plan.md): early implementation plan.
