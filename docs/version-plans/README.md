...
This directory contains version-specific plans and roadmap documents.

Most per-version plans here are completed historical planning records. Keep
them for traceability, but do not treat them as current product truth once a
matching file exists in [../version-notes/](../version-notes/).
...
[../version_skill_workflow.md](../version_skill_workflow.md). Completed work
should also produce a matching note in [../version-notes/](../version-notes/).
