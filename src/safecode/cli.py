...
def help_all_cmd(
    ...
    if all_cmds:
        ...
        console.print("  /status  workspace dashboard and next safe step")
        console.print("  /continue  take the next safe step or explain the blocker")
        console.print("  /memory  /ready  /demo  /task  /model  /provider status  /apply")
