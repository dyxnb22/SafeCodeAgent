...
DECISION_MATRIX: tuple[DecisionScenario, ...] = (
    ...
    DecisionScenario(Action.memory_fact_inject, "viewer", "AUTO", "AUTO", "AUTO"),
    DecisionScenario(Action.memory_fact_inject, "viewer", "AUTO", "AUTO", "BLOCK", context={"fact_status": "pending"}),
